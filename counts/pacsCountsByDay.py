''' Stand-alone script for producing DICOM file counts for each study in the PACS year/month/day structure1,1
ppopp
    Log:
...
parser.add_argument("--outpath", "-o", help = "Output file path. Default to current/counts/.", type = int)
